...
##### Sentinel-2 {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/sol_s2.jpg")
```

##### Probability {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/sol_probability_osm.jpg")
```

##### Classification {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/sol_species.jpg")
```
...
##### Sentinel-2 {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/har_s2.jpg")
```

##### Probability {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/har_probability.jpg")
```

##### Classification {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/har_species.jpg")
```
...
##### Sentinel-2 {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/goe_s2.jpg")
```

##### Probability {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/goe_probability.jpg")
```

##### Classification {-}
```{r, out.width = "100%"}
knitr::include_graphics("https://github.com/wiesehahn/baumarten/blob/master/docs/figure/evaluation.Rmd/goe_species.jpg")
```
