...
pal <- colorFactor(c("#fecc00", "#bf7013","#4066aa","#a5027c", "#94a6b0", "#e20030"), ref@data$BA)

# set color palette for plotly 
pal.ref <- c("#fecc00", "#bf7013","#4066aa","#a5027c", "#94a6b0", "#e20030") %>%
